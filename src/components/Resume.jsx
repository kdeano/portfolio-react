  ...
  return (
    <div name="resume" className="w-full h-full bg-body text-gray-300 pb-20">
      ...
      <div className="max-w-[1000px] mx-auto p-4 pt-[10rem] block justify-center w-full h-full">
        ...
        <p className="text-center">+44 783 281 669</p>

        {/* Profile header */}
        <div className="w-full h-[2.5rem] mt-4 bg-pink-600">
          <h1 className="text-white text-2xl font-bold px-2 py-1">PROFILE</h1>
        </div>
        ...
        <div className="w-full h-[2.5rem] mt-4 bg-pink-600">
          <h1 className="text-white text-2xl font-bold px-2 py-1">EDUCATION & QUALIFICATIONS</h1>
        </div>

        {/* Education & qualifications bio */}
        {/* Sheffield Hallam */}
        <h2 className="text-white text-lg text-left mt-2 px-2 font-semibold">Sheffield Hallam University | BSc Computer Science<span className="float-right">Sep 2019 - Expected 2022</span></h2>
        ...
        {/* Oldham College */}
        <h2 className="text-white text-lg text-left mt-10 px-2 font-semibold">Oldham College | Advanced Technical Extended Diploma<span className="float-right">Sep 2017 - Jun 2019</span></h2>
        ...
        {/* Newman RC College */}
        <h2 className="text-white text-lg text-left mt-10 px-2 font-semibold">Newman R.C. College<span className="float-right">Sep 2012 - Jun 2017</span></h2>
        ...
        <h2 className="text-white text-lg text-left mt-2 px-2 font-semibold">Bar Staff | CODE Nightclub<span className="float-right">Jun 2021 - Present</span></h2>
        ...
        {/* Co-op Food */}
        <h2 className="text-white text-lg text-left mt-10 px-2 font-semibold">Customer Team Member | Co-op Food<span className="float-right">Mar 2020 - Jun 2020</span></h2>
